...
print('\n' * 100) # Очищаем экран, выводя несколько символов новой строки.
...
firstBox = 'RED ' # Обратите внимание на пробел после "D".
secondBox = 'GOLD'
...
# Данная модификация возможна благодаря переменной 'carrotInFirstBox'
if carrotInFirstBox:
