"""Вопросы с подвохом, (c) Sayfullin Ruslan aka CryptoLis.
...
'answer': "An envelope.",
'accept': ['envelope']},{'question': "Is it possible to draw a square with three sides?",
...
print('''Trick Questions, by , (c) Sayfullin Ruslan aka CryptoLis.
...
for questionNumber, qa in enumerate(QUESTIONS): # Основной цикл программы.
    print('\n' * 40) # Очищаем экран.
